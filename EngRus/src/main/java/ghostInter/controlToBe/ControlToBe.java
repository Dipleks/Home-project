...
class ControlToBe implements Root
{
    ...
    void exercise(final FillingColumnsToBe[] app, final FillingColumnsToBe[] neg, final FillingColumnsToBe[] ques,
...
//                tobeQues.setStyle("-fx-border-color: RED");
        ...
        Runnable runnable1 = () -> {
            for (int i = 0; i < buttonToBeapp.length; i++) {
                ...
                int finalI = i;
                buttonToBeapp[i].setOnAction(event -> {
...
//                lengthButtonApp.setStyle("-fx-border-color: RED");
        ...
        Runnable runnable2 = () -> {
            for (int i = 0; i < buttonToBeneg.length; i++) {
                ...
                int finalI = i;
                buttonToBeneg[i].setOnAction(event -> {
...
//                lengthButtonNeg.setStyle("-fx-border-color: RED");
        ...
        Runnable runnable3 = () -> {
            for (int i = 0; i < buttonToBeques.length; i++) {
                ...
                int finalI = i;
                buttonToBeques[i].setOnAction(event -> {
...
//                lengthButtonQues.setStyle("-fx-border-color: RED");
    ...
    void examMethod(final FillingColumnsToBe[] exam, final Button[] buttonPSexam){
        Runnable runExamLab = () -> {
