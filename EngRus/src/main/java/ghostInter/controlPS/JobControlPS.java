...
public class JobControlPS implements Root
{
    ...
    public void exercise(final SceletVBoxPS[] app, final SceletVBoxPS[] neg, final SceletVBoxPS[] ques,
...
//                lengthButtonQues.setStyle("-fx-border-color: RED");
    ...
    public void examMethod(final SceletVBoxPS[] exam, final Button[] buttonPSexam){
        Runnable runExamLab = () -> {
